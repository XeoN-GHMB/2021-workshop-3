import{x as _,y,z as $,_ as r,A as v,B as b,C as x,L as T,D as C,E as f,$ as u,G as A,H as w,I as B,J as I,K as S,M as E,m as z,j as W,o as L,c as O,d as a,t as H,q as P,v as V,f as k}from"./vendor.0ffd3825.js";import{c as F}from"./counterLogic.31a1ceb1.js";import{_ as G}from"./index.ce92e350.js";var N=_`
  ${y}
...
`,g=class extends x{constructor(){super(...arguments);this.attrId=C(),this.componentId=`sl-tab-panel-${this.attrId}`,this.name="",this.active=!1}connectedCallback(){super.connectedCallback(),this.id=this.id.length>0?this.id:this.componentId}render(){return this.style.display=this.active?"block":"none",u`
    ...
    `}};g.styles=M;r([b({reflect:!0})],g.prototype,"name",2);r([b({type:Boolean,reflect:!0})],g.prototype,"active",2);g=r([w("sl-tab-panel")],g);var R="/static/app/shoelace.6e4e3320.svg";const q={name:"ShoelaceView",setup(t,o){const s=z("global"),{removeFromCounter:e}=F(s),p=W(null);function n(h){h.detail.name==="dialog"&&l()}function l(h){p.value.show()}function m(h){p.value.hide()}function D(h){parseInt(h.target.value)===14?h.target.invalid=!1:h.target.invalid=!0}return{tabChange:n,welcomeDialog:p,closeWelcomeDialog:m,checkinput:D,global:s,removeFromCounter:e,openWelcomeDialog:l}}},i=t=>(P("data-v-6ea99012"),t=t(),V(),t),j={class:"shoelace"},K=i(()=>a("img",{src:R},null,-1)),J=i(()=>a("h1",null,"Welcome to Shoelace",-1)),X=i(()=>a("p",null,"Shoelace provides a collection of professionally designed, highly customizable UI components built on a framework agnostic technology.",-1)),Y=i(()=>a("sl-button",{style:{"margin-top":"20px"},href:"https://serene-allen-537100.netlify.app/"},[a("sl-icon",{slot:"prefix",name:"box-arrow-up-right"}),k(" Shoelace Documentation")],-1)),Q=i(()=>a("br",null,null,-1)),Z=i(()=>a("br",null,null,-1)),tt=i(()=>a("br",null,null,-1)),ot=i(()=>a("h3",null,"Some Examples",-1)),at=i(()=>a("sl-tab",{slot:"nav",panel:"buttons",active:""},"Buttons",-1)),et=i(()=>a("sl-tab",{slot:"nav",panel:"dialog"},"Dialog",-1)),st=i(()=>a("sl-tab",{slot:"nav",panel:"elements"},"Elements",-1)),rt={name:"buttons",active:""},lt=i(()=>a("sl-button",{variant:"danger",outline:""},"Button",-1)),it=i(()=>a("sl-dropdown",null,[a("sl-button",{slot:"trigger",caret:""},"Dropdown"),a("sl-menu",null,[a("sl-menu-item",null,"Item 1"),a("sl-menu-item",null,"Item 2"),a("sl-menu-item",null,"Item 3")])],-1)),nt=i(()=>a("sl-button",{variant:"default"},[a("sl-icon",{name:"gear"})],-1)),ct=i(()=>a("sl-button",null,[k(" Badges "),a("sl-badge",{variant:"danger",pill:""},"6")],-1)),pt={name:"dialog"},bt={content:"This is a tooltip"},dt={name:"elements"},ut={ref:"welcomeDialog",label:"Dialog",class:"dialog-overview"},ht=k(" Welcome to a shoelace dialog "),gt=i(()=>a("h3",null,"Use a global State counter",-1));function vt(t,o,s,e,p,n){return L(),O("div",j,[K,J,X,Y,Q,Z,tt,ot,a("sl-tab-group",{onSlTabShow:o[3]||(o[3]=(...l)=>e.tabChange&&e.tabChange(...l))},[at,et,st,a("sl-tab-panel",rt,[a("sl-button-group",null,[a("sl-button",{variant:"primary",onClick:o[0]||(o[0]=(...l)=>e.openWelcomeDialog&&e.openWelcomeDialog(...l))},"Button"),lt,it,nt,ct])]),a("sl-tab-panel",pt,[a("sl-tooltip",bt,[a("sl-button",{onClick:o[1]||(o[1]=(...l)=>e.openWelcomeDialog&&e.openWelcomeDialog(...l))},"Hover Me")])]),a("sl-tab-panel",dt,[a("sl-input",{clearable:"",placeholder:"this input is empty",label:"7+7","help-text":"Please enter the correct value",onInput:o[2]||(o[2]=(...l)=>e.checkinput&&e.checkinput(...l))},null,32)])],32),a("sl-dialog",ut,[ht,a("sl-button",{slot:"footer",variant:"primary",onClick:o[4]||(o[4]=(...l)=>e.closeWelcomeDialog&&e.closeWelcomeDialog(...l))},"close")],512),gt,a("sl-button",{type:"primary",onClick:o[5]||(o[5]=(...l)=>e.removeFromCounter&&e.removeFromCounter(...l))},H(e.global.state.counter),1)])}var yt=G(q,[["render",vt],["__scopeId","data-v-6ea99012"]]);export{yt as default};
