import{y as R,z as V,_ as s,D as S,P as F,$ as b,H as T,I as H,B as P,C as _,M as U,Q as N,R as q,G as f,S as k,T as x,U as L,n as z,a as D,V as M,W as $,o as v,c as p,X as C,Y as A,Z as I,d as n,a0 as O,v as W,x as G,g as j,b as K,e as X,q as E}from"./vendor.55e829ed.js";import{R as m,_ as B}from"./index.b4977d0d.js";var J=R`
  ${V}
...
`,d=Object.assign(document.createElement("div"),{className:"sl-toast-stack"}),o=class extends S{constructor(){super(...arguments);this.open=!1,this.closable=!1,this.variant="primary",this.duration=1/0}firstUpdated(){this.base.hidden=!this.open}async show(){if(!this.open)return this.open=!0,q(this,"sl-after-show")}async hide(){if(!!this.open)return this.open=!1,q(this,"sl-after-hide")}async toast(){return new Promise(t=>{d.parentElement===null&&document.body.append(d),d.appendChild(this),requestAnimationFrame(()=>{this.clientWidth,this.show()}),this.addEventListener("sl-after-hide",()=>{d.removeChild(this),t(),d.querySelector("sl-alert")===null&&d.remove()},{once:!0})})}restartAutoHide(){clearTimeout(this.autoHideTimeout),this.open&&this.duration<1/0&&(this.autoHideTimeout=window.setTimeout(()=>this.hide(),this.duration))}handleCloseClick(){this.hide()}handleMouseMove(){this.restartAutoHide()}async handleOpenChange(){if(this.open){f(this,"sl-show"),this.duration<1/0&&this.restartAutoHide(),await k(this.base),this.base.hidden=!1;const{keyframes:t,options:a}=x(this,"alert.show");await L(this.base,t,a),f(this,"sl-after-show")}else{f(this,"sl-hide"),clearTimeout(this.autoHideTimeout),await k(this.base);const{keyframes:t,options:a}=x(this,"alert.hide");await L(this.base,t,a),this.base.hidden=!0,f(this,"sl-after-hide")}}handleDurationChange(){this.restartAutoHide()}render(){return b`
      <div
        part="base"
